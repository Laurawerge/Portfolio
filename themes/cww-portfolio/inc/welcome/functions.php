...
function cww_portfolio_suggest_plugins() {
	...
	$plugins = array(
		...
		'contact-form-7'     => array(
			...
			'description' 	=> esc_html__( 'The Contact Form for easily adding forms.','cww-portfolio' ),
			'activate'    	=> array(
				'label' 	=> esc_html__( 'Activate', 'cww-portfolio' ),
			),
			'install'     	=> array(
		...
		'cf7-popups'    => array(
			'title'       	=> esc_html__( 'Popups - Submission Message For Contact Form 7', 'cww-portfolio' ),
			'description' 	=> esc_html__( 'Replace default message of contact form 7 with stylish popups.', 'cww-portfolio' ),
			'activate'    	=> array(
					'label' => esc_html__( 'Activate', 'cww-portfolio' ),
				),
			'install'     	=> array(
...
function cww_portfolio_tgma_suggest_plugins() {
	$plugins = array(
		...
		array(
			'name'     => 'Popups - Submission Message For Contact Form 7',
			'slug'     => 'cf7-popups',
			'required' => false,
		),
		array(
